...
def test_import_rate_game():
    """Funkce game_piskvorky.rate_game se dá naimportovat"""
    from game_piskvorky import rate_game


@pytest.mark.level(2)
def test_rate_game_vyhru_x():
    """Křížky vyhrály"""
    from game_piskvorky import rate_game
    assert rate_game('xxx-----------------') == 'x'


@pytest.mark.level(2)
def test_rate_game_vyhru_o():
    """Kolečka vyhrála"""
    from game_piskvorky import rate_game
...
@pytest.mark.level(3)
def test_rate_game_remizu():
    """Nastala remíza"""
    from game_piskvorky import rate_game
    assert rate_game('oxoxoxoxoxoxoxoxoxox') == '!'
    assert rate_game('xxooxxooxxooxxooxxoo') == '!'


@pytest.mark.level(4)
def test_rate_game_hru():
    """Hra neskončila"""
    from game_piskvorky import rate_game
...
def test_import_tah_hrace():
    from game_piskvorky import tah_hrace
